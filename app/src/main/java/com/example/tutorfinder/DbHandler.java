...
public class DbHandler extends SQLiteOpenHelper {
    ...
    public Cursor contains(Tutors tutor) {
        SQLiteDatabase db = this.getReadableDatabase();
        ArrayList<Cursor> arList = new ArrayList<Cursor>();
        Cursor c = db.rawQuery("SELECT * FROM tutors WHERE Name = '" + tutor.Name + "' and Class1 = '" + tutor.Class1 + "'and Subject = '" + tutor.Subject + "'and PhoneNumber = '" + tutor.PhoneNumber + "'", null);
